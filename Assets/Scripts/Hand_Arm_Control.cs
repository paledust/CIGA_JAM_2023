...
public class Hand_Arm_Control : MonoBehaviour
{
[Header("Joints")]
...
[Header("Hand Control")]
    ...
    [SerializeField] private Transform handRenderTrans;
    ...
    //Hand Rotation Update
        {
            float angle = handMoving.positionOffset.x*rotateRatio;
            angle = Mathf.Clamp(angle, -maxAngle, maxAngle);
            handRenderTrans.localRotation = Quaternion.Euler(0,0,angle);
        }
    }
}
